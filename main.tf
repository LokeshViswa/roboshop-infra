...
module "rds" {
  source = "github.com/LokeshViswa/tf-module-rds"
  env    = var.env
...
module "alb" {
  source = "github.com/LokeshViswa/tf-module-alb"
  env    = var.env
...
module "apps" {
  ...
  subnet_ids = lookup(lookup(lookup(lookup(module.vpc, each.value.vpc_name, null), each.value.subnets_type, null), each.value.subnets_name, null), "subnet_ids", null)
  vpc_id     = lookup(lookup(module.vpc, each.value.vpc_name, null), "vpc_id", null)
  allow_cidr = lookup(lookup(lookup(lookup(var.vpc, each.value.vpc_name, null), each.value.allow_cidr_subnets_type, null), each.value.allow_cidr_subnets_name, null), "cidr_block", null)  component  = each.value.component
